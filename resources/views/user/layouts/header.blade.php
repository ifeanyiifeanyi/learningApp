<header class="header-menu-area">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid" src="{{ asset(auth()->user()->photo) }}" alt="Avatar image">
                                                    </div>
                                                    <span class="dot-status bg-1"></span>
                                                </div>
                                                <ul class="p-0 cart-dropdown-menu after-none notification-dropdown-menu">
                                                    <li class="menu-heading-block d-flex align-items-center">
                                                        ...
                                                        <div class="ml-2">
                                                            <h4><a href="teacher-detail.html" class="text-black">{{ Str::title(auth()->user()->username) }}</a></h4>
                                                            <span class="d-block fs-14 lh-20">{{ Str::lower(auth()->user()->email) }}</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul class="generic-list-item">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('user.profile.view') }}">
                                                                    <i class="mr-1 la la-user"></i>profile
                                                                </a>
                                                            </li>
                                                            <li>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        ...
        <ul class="pt-1 pb-2 generic-list-item off-canvas-menu-list border-bottom border-bottom-gray">
            ...
            <li><a href="{{ route('user.profile.update') }}">Edit profile</a></li>
